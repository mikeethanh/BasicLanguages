...
public class test {
	public static void main(String[] args) {
		...
		//tao ra 1 đối tương danh sách sinh vien thuộc class ...
...
//				1.	Thêm sinh viên vào danh sách.
				...
				//tạo ra 1 dối tượng mới thuộc lớn sinh viên
				//gọi constructor 4 tham số trong class SinhVien
				SinhVien sv = new SinhVien(maSinhVien, hoVaTen, namSinh, diemTrungBinh);
				//gọi method tuwf class danhsachsinhvien 
				//method nhận 1 object
...
//				6.	Kiểm tra sinh viên có tồn tại trong danh sách hay không, dựa trên mã sinh viên.
				System.out.println("Nhập mã sinh viên: "); String maSinhVien = sc.nextLine();
				//khai bao ra 1 object sv thuoc class SinhVien
				//goi ham tao 1 tham so 
